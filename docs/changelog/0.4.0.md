...
- [§FS-init.2.4](../functional-spec/FS-init.md#24-generated-grundtoml): generated `.agents/grund.toml` templates now document constrained option sets inline, and init fixture specs cite the generated config contract directly. PR #14.
