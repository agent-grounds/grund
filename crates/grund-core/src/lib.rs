...
pub use api::{
    ...
    RefsQueryFailure, RefsQueryFailureKind, RefsWithMetadata, check, check_with_opts,
    check_with_run_warnings, complete_ids, complete_ids_with_run_warnings, config_run_warnings,
    config_warnings, cover, cover_text, effective_config, format_references, list,
    list_with_run_warnings, lsp_snapshot, lsp_snapshot_with_metadata, propose_id,
