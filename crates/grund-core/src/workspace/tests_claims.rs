...
//! scopes the alias-path guarantee therefore covers. What answering a claim
//! obliges a block to is `tests_claim_answers.rs`; what a single `members` list
//! may contain is `tests_nested.rs`.
